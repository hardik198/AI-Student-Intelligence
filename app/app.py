...
# ============================================================
    ...
    st.write(
        "Performance analysis of the trained Random Forest model."
    )

    if not MODEL_AVAILABLE:

        st.error(
            "The ML model or evaluation module could not be loaded."
        )
        ...
        try:
            ...
            report_df = evaluation["report_df"].copy()
            ...
            cm_df = evaluation["confusion_matrix_df"]
            ...
            ax.set_title("Student Outcome Confusion Matrix")
            ...
            st.info(
                ...
                **{evaluation['accuracy'] * 100:.2f}%**
                on the test dataset.

                The Macro F1 Score is
                **{evaluation['macro_f1'] * 100:.2f}%**,
                which summarizes F1 performance across the
                three student outcome classes.

                The feature-importance chart shows which
                input features contributed most to the
